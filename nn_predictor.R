...
full_series <- ts(rollmean(final[[metric_name]], 60), frequency = 1440)
rough_series <- ts(final[[metric_name]], frequency = 1440)
train_series <- window(full_series, start=1,end=4)
test_series <- window(rough_series, start=4, end=6)
